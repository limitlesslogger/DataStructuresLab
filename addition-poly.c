...
/*
Enter the coeffecients and exponents in DESCENDING orderEnter the number of terms in polynomial2:
Enter the coeffecients and exponents in DESCENDING order
Expression 1 = 0.00x^0 
Expression 2 = 0.00x^0 
The resultant expression is: 0.00x^0
*/