...
{
    int i;
    starta = avail;//start a is at 0
    int numTerms=0;
    printf("Enter the number of terms in polynomial1:");
    scanf("%d", &numTerms);
    finisha=numTerms-1;//last index of polynomial a
    ...
    //avail is at last index of second polynomial
    ...
    startd = avail+1;//avail is at last index of second polynomial same as start of resultant
    finishd = avail+1;//whyyyy by  this d ka end second last index of second polynomial par hai
    startb = finisha + 1;
