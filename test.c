...
nd* add_poly(nd* head1, nd* head2)
{
    ...
    // Check if both polynomials have no terms
    ...
    {
        while (ptr1 != NULL || ptr2 != NULL) // At least one polynomial has terms to compare
        {
            nd* new_node = (nd*)malloc(sizeof(nd));
            new_node->next = NULL;

            if (ptr1 != NULL && ptr2 != NULL) // Both polynomials have terms to compare
            {
